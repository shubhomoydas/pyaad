...
# To run:
# bash ./run-if_aad.sh <dataset> <budget> <reruns> <tau>
#
# inferencetype(s):
#   1-Simple, 
...
#
# Examples:
# bash ./run-if_aad.sh toy 10 2 0.03
...
SCRIPT_PATH=pyalad/isolation_forest_detector.py
...
RESULTS_PATH="${BASE_DIR}/results/$DATASET/${NAME_PREFIX}"
