...
#
# To run:
# bash ./tree_aad-job.sh <dataset> <budget> <reruns> <tau> <inference_type> <query_type> <query_confident[0|1]> <streaming[0|1]> <streaming_window>
#
# Examples:
# bash ./tree_aad-job.sh toy2 10 1 0 0.03 7 1 0 0 512
...
if [[ "$STREAMING_IND" == "1" ]]; then
    STREAMING_SIG="_stream${STREAM_WINDOW}c${QUERY_CONFIDENT}"
else
    STREAMING_SIG=
fi
